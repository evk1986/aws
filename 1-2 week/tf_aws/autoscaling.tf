...
/usr/bin/aws s3 cp s3://${aws_s3_bucket.my_bucket.id}/${aws_s3_bucket_object.text_file.id} /opt/${aws_s3_bucket_object.text_file.id}.txt
cat /opt/${aws_s3_bucket_object.text_file.id}.txt
  EOF
}
